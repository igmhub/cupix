...
if not os.path.exists(gadget_short_info_file):
    print("Gadget simulation info file doesn't exist yet, please run generate_gadget_minmax_file.py first.")
else:
    print("Gadget simulation info file exists at", gadget_short_info_file, "Loading it.")
