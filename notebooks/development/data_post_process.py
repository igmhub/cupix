...
# %%
root = '/Users/ssatyavolu/projects/DESI/Y3_Lya_Px/likelihood/cupix/data/px_measurements/raw_mocks/'
...
max_k = px_data.k_Nyq
k_max_ratio = 2 # maximum frequency will be max_k/k_max_ratio
...
#for i in range(len(theta_min_A)):
#   plt.plot(k_M,P_z_AM[0,i,:],label=theta_min_A[i])
#   plt.plot(k_M,Php_z_AM[0,i,:],linestyle='--',label='Healpix average')
#plt.legend()
#plt.show()
