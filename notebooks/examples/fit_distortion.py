...
# %%
if True:
    z = [ mini.like.theory.z for mini in true_minis]
    ...
    val = [ mini.like.theory.lya_model.default_lya_params['bias'] for mini in true_minis ]
...
if True:
    ...
    plt.errorbar(z, val, err, label='Px fits')
    val = [ mini.like.theory.lya_model.default_lya_params['beta'] for mini in true_minis ]
    plt.plot(z, val, 'ro', label='Xi3D fits')
    plt.xlabel('z')
    plt.ylabel('beta')
    plt.legend()
...
# %%
if True:
    z = [ mini.like.theory.z for mini in unco_minis]
...
if True:
    z = [ mini.like.theory.z for mini in unco_minis]
    ini_chi2 = [ mini.like.get_chi2() for mini in unco_minis]
